...
- 移除 GitHub 提交热力图:设备 TLS 层对所有证书链的 RSA 验签都无法完成,该功能在根因查明前先下线,释放约 165KB 固件空间(应用余量升至 34%)。取而代之,宠物卡片升级为真正的拓麻歌子式像素宠物:蛋 2 分钟孵化,依次成长为幼年/少年/成年(黑白点阵精灵,双帧待机动画);饱食/心情/清洁/精力随真实时间衰减,离线也会结算(封顶 3 天);会周期性拉便便需要清理;睡觉恢复精力。宠物布局内 ▲/▼ 选择动作(喂食/玩耍/清洁/睡觉-叫醒),OK 执行;状态存 NVS,重启不丢。主页布局现为三种(名片/二维码/宠物)。
